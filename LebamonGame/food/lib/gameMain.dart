...
class _GamePageState extends State<GamePage> {
  ...
  static double oakX=5;//-2.25
  static double oakY=2;//-0.75  //Variables
  ...
  void pressedA() {
    ...
    if (currentLocation == 'StartMap') {
      ...
      if (chatStart(countPressingA,dobList, mapX, mapY)) {
        ...
        setState(() {
          ++countPressingA;
          if(countPressingA==3 || countPressingA>=11){
            chatStarted=false;
          }
